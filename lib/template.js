module.exports = {
    ListButton: function(filelist){
        ...
        for(var i=0; i<filelist.length; i++){
            buttonList += `<li class="col-3 col-md-2"><a href="/pages/${filelist[i]}"><button type="button" class="Portfolio_TextButton rounded w-100">${filelist[i]}</button></a></li>`;
        }
        buttonList += '</ul>';
        return buttonList;
    },
